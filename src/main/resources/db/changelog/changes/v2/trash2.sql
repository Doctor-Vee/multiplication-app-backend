with user_pricing as (SELECT pud.international_percentage                                           AS intlDiscountPercentage,
     ...
     default_pricing AS (SELECT o.id                                                                   AS operatorId,
                         ...
                         GROUP BY operatorId AND o.deleted_at IS NULL AND po.deleted_at IS NULL
GROUP BY o.id, o.name, c.name
ORDER BY c.name, o.name )
SELECT operatorId, operatorName, countryName, intlDiscountPercentage, localDiscountPercentage, intlRangeAmountDeductionPercentage, intlFixedAmountDeductionPercentage, intlFeeAmount, intlFeePercentage, localFeeAmount, localFeePercentage, operatorTransactionStatus, providerToUseForDenominationsDisplay, userFxRate, userFxRateOverride, userFxRateLocal, providerOperatorId, fxRateInUse, providerOperatorStatus, providerRequiresLocalAmount, fxControlledInHouse, providerId, providerOperatorAmountId, denominationType, intlMinAmount, intlMaxAmount, localMinAmount, localMaxAmount, customRoutingOperatorId, customRoutingAllowFailover, customRoutingProviderId, customRoutingDeletedAt, customRoutingProviderStatus, customRoutingProviderName, fixedInternationalAmounts, fixedInternationalAmountsWithMarkup, fixedLocalAmountsWithMarkup, fixedLocalAmounts, localAmountCurrencyCode
FROM user_pricing
UNION
SELECT operatorId, operatorName, countryName, intlDiscountPercentage, localDiscountPercentage, intlRangeAmountDeductionPercentage, intlFixedAmountDeductionPercentage, intlFeeAmount, intlFeePercentage, localFeeAmount, localFeePercentage, operatorTransactionStatus, providerToUseForDenominationsDisplay, userFxRate, userFxRateOverride, userFxRateLocal, providerOperatorId, fxRateInUse, providerOperatorStatus, providerRequiresLocalAmount, fxControlledInHouse, providerId, providerOperatorAmountId, denominationType, intlMinAmount, intlMaxAmount, localMinAmount, localMaxAmount, customRoutingOperatorId, customRoutingAllowFailover, customRoutingProviderId, customRoutingDeletedAt, customRoutingProviderStatus, customRoutingProviderName, fixedInternationalAmounts, fixedInternationalAmountsWithMarkup, fixedLocalAmountsWithMarkup, fixedLocalAmounts, localAmountCurrencyCode
